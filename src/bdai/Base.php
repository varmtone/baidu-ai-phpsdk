...
use Bdai\http\Client as AipHttpClient;
/**
 * Aip Base 基类
 */
abstract class Base {
     ...
     * 设置请求超时时长
     *
     * @param int $millsec 超时时长 单位毫秒ms
     */
    public function setTimeout($millsec=60000){
        $this->client->setSocketTimeoutInMillis($millsec);
        $this->client->setConnectionTimeoutInMillis($millsec);
    }
